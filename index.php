...
function generateUrl($nodeName){
    global $p;
    //以下是如果某节点路径$p是以"{$pathDefault}/Manules/phpmanule/man/"开头的就生成以"file://{$pathDefault}/Manules/phpmanule/man/"为前缀的url地址.
    if(0 === strpos($p, "{$pathDefault}/Manules/phpmanule/man/")){
